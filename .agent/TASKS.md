...
3b. [x] Brush entities (models *N) placed by entity origin/angles (static). [x] Linear `func_door` movement with synced kinematic collision. [x] `trigger_changelevel` transition. [x] 2D sky. [ ] sky_camera 3D skybox. [ ] render targets (_rt_camera).
