...
Version: 0.10.0 (dev)
Milestone: M3 Renderer — in progress. `+map d1_trainstation_01` loads the BSP, mounts its pakfile, draws world geometry (base textures, lightmaps, displacements with WorldVertexTransition blend), 2D sky, brush entities and static props with PVS + frustum culling; free camera. Next: prop lighting beyond leaf ambient, translucent sorting, water, 3D skybox.
