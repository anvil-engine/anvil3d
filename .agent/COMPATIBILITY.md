...
| Entity I/O  | PARTIAL (bounded generic outputs and delayed queue; `logic_auto` spawn, `logic_relay`, `logic_timer`, `logic_branch`, `math_counter`, triggers including `trigger_changelevel`, moving door/button/breakable dispatch) | NOT STARTED | NOT STARTED |
