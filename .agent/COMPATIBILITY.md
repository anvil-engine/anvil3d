...
| Models      | PARTIAL (LOD0 mesh, skeleton/sequence metadata, inline raw/RLE poses, CPU skinning and diagnostic render submission; no blending/external blocks) | NOT STARTED | NOT STARTED |
