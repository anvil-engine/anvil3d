...
| Entity I/O  | PARTIAL (bounded generic outputs and delayed queue; `logic_auto` spawn, `logic_relay`, `logic_timer`, `logic_branch`, `math_counter`, triggers, and linear `func_door` dispatch) | NOT STARTED | NOT STARTED |
