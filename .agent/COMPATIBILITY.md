...
- Audio: PCM WAV resources are decoded from VFS and `ambient_generic` uses SDL3 playback with authored volume, pitch, radius, loop and common control inputs. Source sound scripts remain unsupported.
