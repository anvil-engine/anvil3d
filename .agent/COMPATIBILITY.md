...
| Models      | PARTIAL (LOD0 mesh, skeleton/sequence metadata, inline raw/RLE poses and CPU skinning; no blending/external blocks/render submission) | NOT STARTED | NOT STARTED |
