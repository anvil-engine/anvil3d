...
struct CollisionStats { size_t brushes = 0, rejected = 0, displacementTriangles = 0, propTriangles = 0, propHulls = 0; };
// World and static brush placements, independent of render visibility/materials (nodraw is still solid).
// `fs` enables authored model PHY collision for static props and prop_physics.
