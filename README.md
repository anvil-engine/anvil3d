...
`+vgui_scheme resource/clientscheme.res DefaultSmall 768` inspects the original font variants for a 768-pixel screen height and character `A`, preserving fallback order. VGUI schemes now resolve named colors and BaseSettings aliases, font resolution/character ranges, and declared custom font paths. Font rasterization, proportional scaling and panel execution remain unsupported.
