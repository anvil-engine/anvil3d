...
`scripted_sequence` can schedule or repeat a named animation on a loaded `prop_dynamic`, with `BeginSequence`, `CancelSequence`, and lifecycle outputs. NPC ownership, AI, and other sequence targets remain unsupported. See [.agent/COMPATIBILITY.md](.agent/COMPATIBILITY.md).
